...
# Blender Addon : Linked Librairy Auto Reload

Auto reload linked librairy
...
1. Download latest version from [Release](https://github.com/Ni-g-3l/blender-linked-librairy-auto-reload/releases)
2. Install it thnaks to the Blender Addon Manager

## 🔢 Versioning

We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/Ni-g-3l/blender-linked-librairy-auto-reload/tags).

## 🤹 Authors / Contributers / Attributions

* **Ni-g-3l** - *Main Developer* - [Github](https://github.com/Ni-g-3l/)

See also the list of [contributors](https://github.com/Ni-g-3l/blender-linked-librairy-auto-reload/contributors) who participated in this project.
